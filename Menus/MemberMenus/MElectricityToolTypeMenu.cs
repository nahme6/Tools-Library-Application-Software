...
namespace Tools_Library_Application_Software
{
    public class MElectricityToolTypeMenu
    {
        ...
        public static void toolCategoryMenuNext(int menuOption)
        {
            ...
            {
                case 1:
                    new BorrowToolForm(ToolTypes.testEquipment);
                    break;
                case 2:
                    new BorrowToolForm(ToolTypes.safetyEquipment);
                    break;
                case 3:
                    new BorrowToolForm(ToolTypes.basicHandTools);
                    break;
                case 4:
                    new BorrowToolForm(ToolTypes.circuitProtection);
                    break;
                case 5:
                    new BorrowToolForm(ToolTypes.cableTools);
                    break;
            }
        }
    }
